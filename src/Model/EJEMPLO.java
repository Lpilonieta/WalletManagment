...
public class EJEMPLO {
    ...
    // assets de ejemplo
    private Assets assetTest_1 = new Assets(Constants.RENEUE_FORM_TYPE,"name asset test 1","description AssetTest1","", Constants.CURRENT, (byte) 0,80, Constants.NONE);
    private Assets assetTest_2 = new Assets(Constants.RENEUE_FORM_TYPE,"name asset test 2","description AssetTest2","",Constants.CURRENT, (byte) 0,180, Constants.NONE);
    private Assets assetTest_3 = new Assets(Constants.RENEUE_FORM_TYPE,"name asset test 3","description AssetTest3","",Constants.NO_CURRENT, (byte) 5,500, Constants.NONE);
    private Assets assetTest_4 = new Assets(Constants.RENEUE_FORM_TYPE,"name asset test 4","description AssetTest4","",Constants.CURRENT, (byte) 0,380, Constants.NONE);
    private Assets assetTest_5 = new Assets(Constants.RENEUE_FORM_TYPE,"name asset test 5","description AssetTest5","",Constants.NO_CURRENT, (byte) 10,550, Constants.NONE);

    // pasivos de ejemplo
    private Pasives pasiveTest_1 = new Pasives(Constants.RENEUE_FORM_TYPE,"name pasiveTest 1","deudor 1", "description pasiveTest 1", Constants.LINEAL_INTEREST, 1,1,Constants.NO_CURRENT,Constants.MONTHLY,1);  // TODO: incluir fecha de pago mas cercana al contructor
    private Pasives pasiveTest_2 = new Pasives(Constants.RENEUE_FORM_TYPE,"name pasiveTest 2","deudor 2", "description pasiveTest 2", Constants.COMPOUND_INTEREST, 2,2,Constants.CURRENT,Constants.WEEKLY,2);  // TODO: incluir fecha de pago mas cercana al contructor
    private Pasives pasiveTest_3 = new Pasives(Constants.EXPENSE_FORM_TYPE,"name pasiveTest 3","deudor 3", "description pasiveTest 3", Constants.LINEAL_INTEREST, 3,3,Constants.CURRENT,Constants.DAILY,3);  // TODO: incluir fecha de pago mas cercana al contructor
    private Pasives pasiveTest_4 = new Pasives(Constants.EXPENSE_FORM_TYPE,"name pasiveTest 4","deudor 4","description pasiveTest 4", Constants.COMPOUND_INTEREST, 4,4,Constants.NO_CURRENT,Constants.YEARLY,1);  // TODO: incluir fecha de pago mas cercana al contructor
    private Pasives pasiveTest_5 = new Pasives(Constants.RENEUE_FORM_TYPE,"name pasiveTest 5","deudor 5", "description pasiveTest 5", Constants.LINEAL_INTEREST, 5,5,Constants.CURRENT,Constants.WEEKLY,2);  // TODO: incluir fecha de pago mas cercana al contructor
    ...
    private void setUpForms() {
        ...
        assetTest_3.setPurchaseValue(300);
        assetTest_3.setSource("fuente testForm_3");
        assetTest_3.setMotive("compra Activo");
        assetTest_3.setComments("comments formTest3");
